...
const PortableStructure = () => {
    ...
    return (
        <div>
            ...
            <WhyChooseUs handleOpenVideo={handleOpenVideo} title={"Innovative, Durable, and Versatile Portable Solutions"} desc={"At “DIY PreFab”, we deliver high-performance steel and metal roofing systems that combine strength, aesthetics, and long-term value. Our roofing solutions are ideal for industrial, commercial, and residential prefab structures—ensuring lasting protection in all environments."} />
